...
Table~\ref{tab:demographics} details the distribution of the full dataset
...
Table~\ref{tab:liepa2_stats} summarizes the key statistics of the Liepa~2
corpus.
...
Table~\ref{tab:filtered_liepa2_stats} summarizes the statistics of the filtered
...
% TODO Figure~\ref{fig:spectrogram_comparison},
